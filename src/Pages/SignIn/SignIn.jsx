            ...
            <div className="col-md-6 left-signin order-sm-first order-last">
              <div className="container">
                ...
                <form className="mx-3" onSubmit={handleSubmit}>
                  ...
                  <InputText valueLabel="Password" valueFor="password" type="password" id="password" name="password" placeholder="Masukkan Password" value={password} onChange={(e) => setPassword(e.target.value)} />
                  <button type="submit" className="btn btn-primary btn-sign-in mt-5">Sign In</button>
                  <p className="text-center mt-2" >Belum punya akun? <Link to="/register" style={{fontStyle: "Bold", color: "#014751"}}>Sign Up</Link></p>
                </form>
              </div>
            </div>
          <div className="col-md-6 right-signin">
            <div className="container justify-content-center">
              <h2 className="text-center pw-bold mt-5" style={{fontSize: "36px", color: "#fff"}}>Selamat Datang Di MyNature !</h2>
              <p className="text-center pw-light" style={{fontSize: "16px", color: "#fff"}}>Ayo dukung kami untuk masa depan dunia yang lebih baik </p>
